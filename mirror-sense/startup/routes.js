...
const courseSales = require('../routes/courseSales');
const serviceSales = require('../routes/serviceSales');
const prepaidSales = require('../routes/prepaidSales');
...
module.exports = function (app) {
  ...
  app.use('/mirror/api/payments', payments);
  app.use('/mirror/api/courseSales', courseSales);
  app.use('/mirror/api/serviceSales', serviceSales);
  app.use('/mirror/api/prepaidSales', prepaidSales);
  app.use('/mirror/api/productSales', productSales);
